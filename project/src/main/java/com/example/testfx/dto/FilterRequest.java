...
/**
 * Encapsule les filtres globaux de l'interface utilisateur pour interroger les données.
 * Paramètre F1 (year) : obligatoire
 * Paramètre F2 (selectedCTNs) : liste des CTN, null ou vide = tous
 * Paramètre F3 (nafLevel) : niveau d'agrégation "CTN", "NAF38", "NAF2"
 * Paramètre F4 (indicator) : "atPremierReglement", "indiceFrequence", "tauxGravite", "deces"...
 */
